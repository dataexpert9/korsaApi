...
namespace Component.Utility
{
    public class CryptoHelper
    {
        ...
        public static void SendPushNotifications(List<string> usersToPushAndroid, List<string> usersToPushIOS, NotificationModel Notification, int PushType)
        {
            try
            {

                PushNotifications.SendIOSPushNotification
                   (
                       usersToPushAndroid,
                       isIOS:false,
