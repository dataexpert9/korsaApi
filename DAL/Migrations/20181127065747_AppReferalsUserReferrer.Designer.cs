...
namespace DAL.Migrations
{
    ...
    [Migration("20181127065747_AppReferalsUserReferrer")]
    partial class AppReferalsUserReferrer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.DomainModels.UserAppReferral", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.DomainModels.UserAppReferral", b =>
                {
                    b.HasOne("DAL.DomainModels.User", "InvitedUser")
                        .WithOne("Referrer")
                        .HasForeignKey("DAL.DomainModels.UserAppReferral", "InvitedUser_Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DAL.DomainModels.User", "Referrer")
                        .WithMany("UserAppReferrals")
